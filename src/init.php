...
function default_settings(): array
{
    return [
        ...
        'about_title'       => 'About',
        'about_text'        => "Ramat Eshkol Kosher provides reliable kosher supervision under the guidance of Harav Akiva Dershowitz shlit\"a, Mara D'Asra of Kehilas Nachalas Yaakov, Ramat Eshkol.\n\nEvery establishment under our hashgacha is visited regularly, with ingredients, suppliers and food preparation checked from start to finish. We are always available to answer any question from the community about a business on our list.",
